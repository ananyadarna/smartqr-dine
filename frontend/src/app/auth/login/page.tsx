      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center p-8 md:p-16 bg-white shadow-2xl">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 border border-slate-200 hover:bg-slate-50 text-slate-700 py-3 rounded-xl cursor-pointer transition font-medium text-sm">
